...
public class Constants {
    public static String COULD_NOT_ADD_TODO = "Couldn't add a Todo, Please try again later";
    public static String TODO_SUCCESSFULLY_SAVED = "Todo successfully saved";
